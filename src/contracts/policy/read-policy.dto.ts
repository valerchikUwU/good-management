...
export class PolicyReadDto{
    ...
    @ApiProperty({description: 'Название политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    policyName: string;

    @ApiProperty({description: 'Номер политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    policyNumber: number

    @ApiProperty({description: 'Состояние политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    state: State;

    @ApiProperty({description: 'Тип политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    type: Type;

    @ApiProperty({description: 'Дата активации политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    dateActive: Date;

    @ApiProperty({description: 'Контент политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    content: string;

    @ApiProperty({description: 'Дата создания политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    createdAt: Date;

    @ApiProperty({description: 'Дата обновления политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6'})
    updatedAt: Date;

    @ApiProperty({description: 'Связанный пост политики', example: 'bb1897ad-1e87-4747-a6bb-749e4bf49bf6', nullable: true})
    post: Post;
