...
export class PermissionsGuard implements CanActivate {
    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        const roleSetting = await this.roleSettingService.findByRoleAndModule(user.role.id, module);
    ...
    private checkPermission(roleSettings: RoleSettingReadDto, module: Modules, action: Actions): boolean {
