...
export class DoubleForStatisticData1747145772205 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "statistic_data" ADD "value" numeric NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "statistic_data" DROP COLUMN "value"`);
        await queryRunner.query(`ALTER TABLE "statistic_data" ADD "value" integer NOT NULL`);
    }
