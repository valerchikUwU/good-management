...
export class AddedStatisticAndStatData1726495363608 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."statistic_type_enum" AS ENUM('Прямая', 'Перевернутая')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."policy_type_enum" AS ENUM('Директива', 'Инструкция')`);
        await queryRunner.query(`ALTER TABLE "policy" ADD "type" "public"."policy_type_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "strategy" ADD "content" text NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "project" ADD "strategyId" uuid NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "strategy" ADD "mimetype" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "strategy" ADD "path" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "strategy" ADD "size" integer NOT NULL`);
