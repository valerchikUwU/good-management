...
export class AddedPropTypeToConvert1730994420452 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."convert_converttype_enum" AS ENUM('Прямой', 'Приказ', 'Согласование')`);
        await queryRunner.query(`ALTER TABLE "convert" ADD "convertType" "public"."convert_converttype_enum"`);
