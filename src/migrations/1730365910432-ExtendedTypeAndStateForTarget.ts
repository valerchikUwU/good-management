...
export class ExtendedTypeAndStateForTarget1730365910432 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."target_type_enum" AS ENUM('Обычная', 'Статистика', 'Правила', 'Продукт', 'Организационные мероприятия')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."target_targetstate_enum" AS ENUM('Активная', 'Отменена', 'Завершена', 'Просрочена')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."target_targetstate_enum_old" AS ENUM('Активная', 'Отменена', 'Завершена')`);
        await queryRunner.query(`ALTER TABLE "target" ALTER COLUMN "targetState" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."target_type_enum_old" AS ENUM('Обычная', 'Статистика', 'Правила', 'Продукт')`);
        await queryRunner.query(`ALTER TABLE "target" ALTER COLUMN "type" DROP DEFAULT`);
