...
export class AddToPostFKtoAccountAddTargetNumbers1726759637194
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "project" ADD "projectNumber" SERIAL NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "post" DROP CONSTRAINT "FK_f219a87fd8c020d3bb6527c9420"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "project" DROP COLUMN "projectNumber"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "target" ADD "orderNumber" integer NOT NULL DEFAULT '1'`,
    );
  }
}
