...
export class RemovedOneStateForTarget1730455726129 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."target_targetstate_enum_old" AS ENUM('Активная', 'Отменена', 'Завершена', 'Просрочена')`);
        await queryRunner.query(`ALTER TABLE "target" ALTER COLUMN "targetState" DROP DEFAULT`);
