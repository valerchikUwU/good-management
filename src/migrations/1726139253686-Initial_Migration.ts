...
export class InitialMigration1726139253686 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accountName" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "organization" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "organizationName" character varying NOT NULL, "parentOrganizationId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "accountId" uuid NOT NULL, CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."policy_state_enum" AS ENUM('Черновик', 'Активный', 'Отменён')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."project_type_enum" AS ENUM('Проект', 'Программа')`,
    );
    await queryRunner.query(
      `CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "programId" uuid, "content" text NOT NULL, "type" "public"."project_type_enum" NOT NULL DEFAULT 'Проект', CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."target_type_enum" AS ENUM('Обычная', 'Статистика', 'Правила', 'Продукт')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "target_holder" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "targetId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "REL_b5b7a1399bb79f0a6f817e2629" UNIQUE ("targetId"), CONSTRAINT "PK_be0687cc758ff63787237a40a14" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."strategy_state_enum" AS ENUM('Черновик', 'Активный', 'Завершено')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "organization" ADD CONSTRAINT "FK_a1f50c955a5225aa6146bd38ead" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "target_holder" ADD CONSTRAINT "FK_24d8851d99d78fa2b8ff2882b81" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "objective" ADD CONSTRAINT "FK_3b9f2b0b950b992feb67e225e39" FOREIGN KEY ("strategyId") REFERENCES "strategy"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "objective" DROP CONSTRAINT "FK_3b9f2b0b950b992feb67e225e39"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "target_holder" DROP CONSTRAINT "FK_24d8851d99d78fa2b8ff2882b81"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "organization" DROP CONSTRAINT "FK_a1f50c955a5225aa6146bd38ead"`,
    );
    await queryRunner.query(
