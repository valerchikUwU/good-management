...
export class PolicyAddedOnlyContentForHTMLcode1726567418033
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "policy" ADD "mimetype" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "policy" ADD "path" character varying NOT NULL`,
    );
