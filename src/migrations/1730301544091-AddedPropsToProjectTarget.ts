...
export class AddedPropsToProjectTarget1730301544091
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "target" ADD "targetState" "public"."target_targetstate_enum" NOT NULL DEFAULT 'Активная'`,
    );
    await queryRunner.query(
      `ALTER TABLE "project" ADD "projectName" character varying(50) NOT NULL DEFAULT 'Название проекта'`,
    );
  }
