  ...
  async createSeveral(
    ...
    for (const organizationId of organizationIds) {
      try {
        ...
        const savedRelation =
          await this.policyToOrganizationRepository.save(policyToOrganization);
        ...
        throw new InternalServerErrorException(
          'Ой, что - то пошло не так при добавлении организаций к политике!',
        );
