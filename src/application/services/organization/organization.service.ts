...
export class OrganizationService {
    ...
    async findAllWithoutGoalsForAccount(
        account: AccountReadDto,
    ): Promise<OrganizationReadDto[]> {
        try {
            const organizations = await this.organizationRepository.find({
    ...
    async findAllWithGoalsForAccount(
        account: AccountReadDto,
    ): Promise<OrganizationReadDto[]> {
        try {
            const organizations = await this.organizationRepository.find({
    ...
    async update(
        ...
        try {
            ...
            if (updateOrganizationDto.reportDay)
                organization.reportDay =
                    updateOrganizationDto.reportDay;
            await this.organizationRepository.update(_id, { organizationName: organization.organizationName, parentOrganizationId: organization.parentOrganizationId, reportDay: organization.reportDay });
