...
export class AttachmentToMessageService {
    ...
    async createSeveral(
        ...
        try {
            const attachments = await this.attachmentService.findAllByIds(attachmentIds);
            ...
            throw new InternalServerErrorException('Ошибка при связывании вложений с сообщением!');
        }
    }
